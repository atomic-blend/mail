...
#### Miscellaneous Chores
- **(release)** 0.2.46 [skip ci] - (2fbf1c7) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.43 [skip ci] - (ffcffa8) - GitHub Actions

- - -

## 0.2.43 - 2025-09-22
#### Bug Fixes
- copy the google plist inside the runner directory too - (45e1286) - Brandon Guigo
#### Miscellaneous Chores
- **(release)** 0.2.42 [skip ci] - (0851544) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.35 [skip ci] - (8a083db) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.30 [skip ci] - (65b5990) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.27 [skip ci] - (daf6d6c) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.22 [skip ci] - (d1536c7) - GitHub Actions

- - -

## 0.2.22 - 2025-09-20
#### Bug Fixes
- cleanup file - (a1089e7) - Brandon Guigo
#### Miscellaneous Chores
- **(release)** 0.2.21 [skip ci] - (0f38ca4) - GitHub Actions
...
#### Miscellaneous Chores
- **(release)** 0.2.4 [skip ci] - (90cd372) - GitHub Actions
